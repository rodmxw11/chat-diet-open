...
public class AlexaPathIsolationFilter extends OncePerRequestFilter {
    ...
    private static final Logger log = LoggerFactory.getLogger(AlexaPathIsolationFilter.class);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (onAlexaConnector != isAlexaPath) {
            log.warn("Rejecting {} {} on port {} (onAlexaConnector={}, isAlexaPath={})",
                    request.getMethod(), request.getRequestURI(), request.getLocalPort(),
                    onAlexaConnector, isAlexaPath);
